...
public class NewRemotePDFActivity2 extends BaseSampleActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remote_pdf2);
...
//        }
    ...
    protected void setDownloadButtonListener() {
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NewRemotePDFViewPager remotePDFViewPager = findViewById(R.id.prdView);
                remotePDFViewPager.setUrl(getUrlFromEditText());
    ...
    public static void open(Context context) {
        Intent i = new Intent(context, NewRemotePDFActivity2.class);
